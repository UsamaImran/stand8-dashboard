...
import { getRecruitersApi } from './api';

const { readRecruiterBegin, readRecruiterSuccess } = actions;
...
const getRecruiters = (weekDate, spreadDate) => {
  return async dispatch => {
    ...
    dispatch(readRecruiterBegin());
    const data = await getRecruitersApi(params);
    dispatch(readRecruiterSuccess(data.data));
  };
};
