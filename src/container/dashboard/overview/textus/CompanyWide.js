...
import { performanceFilterData, performanceGetData, setIsLoading } from '../../../../redux/textUs/actionCreator';
...
const CompanyWide = () => {
  ...
  const { performanceState, preIsLoading } = useSelector(state => {
    return {
      performanceState: state.textUsReducer.performanceData,
      preIsLoading: state.textUsReducer.perLoading,
    };
  });
          ...
          <Pstates>
            ...
            >
              ...
              <Heading as="h1">
                ...
                <sub>
                  <span>
                    <FeatherIcon icon={`${sessionsPercent < 0 ? 'arrow-down' : 'arrow-up'}`} size={14} />{' '}
            ...
            >
              ...
              <Heading as="h1">
                ...
                <sub>
                  <span>
                    <FeatherIcon icon={`${bouncePercent < 0 ? 'arrow-down' : 'arrow-up'}`} size={14} />{' '}
            ...
            >
              ...
              <Heading as="h1">
                ...
                <sub>
                  <span>
                    <FeatherIcon icon={`${durationPercent < 0 ? 'arrow-down' : 'arrow-up'}`} size={14} />{' '}
