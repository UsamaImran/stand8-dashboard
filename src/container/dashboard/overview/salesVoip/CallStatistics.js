...
const CallStatistics = ({ user }) => {
  ...
  const { voipCallStatsData, caLoading } = useSelector(rState => {
    return {
      voipCallStatsData: rState.voipPieChartReducer.voipCallStatsData,
      caLoading: rState.voipPieChartReducer.caLoading,
    };
  });
