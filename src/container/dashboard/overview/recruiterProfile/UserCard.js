...
import { getAccountSummary } from '../../../../redux/recruiterProfile/actionCreator';
...
const UserCards = ({ user }) => {
  ...
  const { accountSummary, isLoading, spreadHistory } = useSelector(state => {
    return {
      accountSummary: state.recruiterProfile.accountSummary,
