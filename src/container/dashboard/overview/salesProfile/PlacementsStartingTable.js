...
import { getPlacementStartingSoon } from '../../../../redux/salesProfile/actionCreator';
...
function PlacementsStartingTable({ user }) {
  ...
  const { placementStartingData } = useSelector(state => {
    return {
      placementStartingData: state.salesProfile.placementStartingSoonData,
      isLoading: state.salesProfile.placementStartingSoonLoading,
    };
  });
