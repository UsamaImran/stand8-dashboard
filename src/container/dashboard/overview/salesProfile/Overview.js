...
import { getTextusData, getVoipData } from '../../../../redux/salesProfile/actionCreator';
...
const Overview = ({ user }) => {
  ...
  // const { textusData, voipData } = useSelector(state => {
  //   return {
  //     textusData: state.salesProfile.textusData,
  //     voipData: state.salesProfile.voipData,
  //   };
  // });
