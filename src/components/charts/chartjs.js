...
const ChartjsBarChartTransparent = props => {
  const { labels, datasets, options, height, layout, labelPrefix, barStyle } = props;
  ...
  return (
    <ChartContainer className="parentContainer">
      <div style={barStyle && barStyle} title={barStyle && 'Click to View Details'}>
        <Bar
          data={data}
            ...
            tooltips: {
              ...
              callbacks: {
                label(t, d) {
                  ...
                  return `<span class="chart-data">${prefix +
                    yLabel}</span> <span class="data-label">${dstLabel}</span>`;
                },
