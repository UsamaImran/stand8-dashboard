        ...
        <Row gutter="10">
          ...
          <Col sm={12}>
            <figure className="setting-dropdwon__single d-flex">
              ...
              <figcaption>
                <Heading as="h5">Custom Layout</Heading>
                <p>Complete customization for your needs </p>
              </figcaption>
            </figure>
          </Col>
          <Col sm={12}>
            <figure className="setting-dropdwon__single d-flex">
              ...
              <figcaption>
                <Heading as="h5">Data</Heading>
                <p>We handle ETL process for you </p>
              </figcaption>
            </figure>
          </Col>
          <Col sm={12}>
            <figure className="setting-dropdwon__single d-flex">
              ...
              <figcaption>
                <Heading as="h5">Dashboards</Heading>
                <p>Focus on what you need to see </p>
              </figcaption>
            </figure>
          </Col>
          <Col sm={12}>
