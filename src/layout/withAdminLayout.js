            ...
            >
              <Row>
                <Col lg={!topMenu ? 4 : 3} sm={6} xs={12} className="align-center-v navbar-brand">
                  ...
                  <Link
                    className={topMenu && window.innerWidth > 991 ? 'stand-logo top-menu' : 'stand-logo'}
                    to="/admin"
                  >
                    <img
                      src={
                        !darkMode
                          ? require(`../static/img/STAND8_Logo_white.svg`)
                          : require(`../static/img/STAND8_Logo_white.svg`)
                      }
                      alt=""
                    />
              ...
              <Layout className="atbd-main-layout">
                <Content>
                  ...
                  <Footer className="admin-footer" style={footerStyle}>
                    <Row>
                      <Col md={12} xs={24}>
                        <span className="admin-footer__copyright">2021 © STAND 8</span>
                      </Col>
                      <Col md={12} xs={24}>
